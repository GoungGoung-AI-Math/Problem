package Problem.Math.AI.buildUp;
...
public class CustomEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        try {
            ...
            processBuilder.command("bash", "-c", "ssh -i ~/Desktop/aikey.pem ec2-user@13.209.22.119 'cat /home/ec2-user/problemapp/vault_token.txt'");
            ...
            String usernameProblemDb = secrets.at("/data/data/username_problem_db").asText();
            String passwordProblemDb = secrets.at("/data/data/password_problem_db").asText();

            // 환경 변수 설정
            Map<String, Object> propertyMap = new HashMap<>();
            propertyMap.put("spring.datasource.url", "jdbc:postgresql://13.209.22.119:5434/springdb_problem");
            propertyMap.put("spring.datasource.username", usernameProblemDb);
            propertyMap.put("spring.datasource.password", passwordProblemDb);
